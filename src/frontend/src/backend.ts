...
import type { AuthorInfo as _AuthorInfo, Category as _Category, ExternalBlob as _ExternalBlob, NewsArticle as _NewsArticle, Time as _Time, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createArticle(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ExternalBlob | null, arg5: Category, arg6: AuthorInfo): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createArticle(arg0, arg1, arg2, arg3, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg4), to_candid_Category_n12(this._uploadFile, this._downloadFile, arg5), arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllArticles(arg0: bigint, arg1: bigint): Promise<Array<NewsArticle>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllArticles(arg0, arg1);
    ...
    async getArticleById(arg0: string): Promise<NewsArticle> {
        if (this.processError) {
            try {
                const result = await this.actor.getArticleById(arg0);
                return from_candid_NewsArticle_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getArticlesByCategory(arg0: Category): Promise<Array<NewsArticle>> {
        if (this.processError) {
            try {
                const result = await this.actor.getArticlesByCategory(to_candid_Category_n12(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCategoriesInHindi(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCategoriesInHindi();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateArticle(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ExternalBlob | null, arg5: Category, arg6: AuthorInfo): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateArticle(arg0, arg1, arg2, arg3, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg4), to_candid_Category_n12(this._uploadFile, this._downloadFile, arg5), arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_NewsArticle_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _NewsArticle): Promise<NewsArticle> {
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        imageId: record_opt_to_undefined(await from_candid_opt_n19(_uploadFile, _downloadFile, value.imageId))
    };
}
...
function from_candid_variant_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "interview" in value ? Category.interview : "cinema" in value ? Category.cinema : "viralNews" in value ? Category.viralNews : "politics" in value ? Category.politics : value;
}
...
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_NewsArticle>): Promise<Array<NewsArticle>> {
    return await Promise.all(value.map(async (x)=>await from_candid_NewsArticle_n15(_uploadFile, _downloadFile, x)));
}
...
function to_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.interview ? {
        interview: null
    } : value == Category.cinema ? {
        cinema: null
    } : value == Category.viralNews ? {
        viralNews: null
